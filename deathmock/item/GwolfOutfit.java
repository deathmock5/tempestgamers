...
public class GwolfOutfit{
	...
	protected static String outfitname;
	public static void init()
	{
		...
		hat = new ItemArmorMaidHat(ItemIds.ITEMHEROHAT,ModLoader.addArmor(outfitname));
		top = new ItemArmorMaidTop(ItemIds.ITEMHEROTOP,ModLoader.addArmor(outfitname));
		bottom = new ItemArmorMaidPants(ItemIds.ITEMHEROLEGS,ModLoader.addArmor(outfitname));
		boots = new ItemArmorMaidBoots(ItemIds.ITEMHEROBOOTS,ModLoader.addArmor(outfitname));
